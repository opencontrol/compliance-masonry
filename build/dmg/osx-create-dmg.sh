...
APP_NAME="compliance-masonry"
VERSION=`git describe --abbrev=0 --tags | cut -d"v" -f2`
DMG_BACKGROUND_IMG="../build/dmg/osx-dmg-background.png"

# you should not need to change these
APP_EXE="${APP_NAME}.app/Contents/MacOS/masonry"
...
STAGING_DIR="OSX-DMG-TEMP"  # we copy all our stuff into this dir
...
# add COPYING
cp "../LICENSE.md" /Volumes/"${VOL_NAME}"/
...
echo '
   tell application "Finder"
     tell disk "'${VOL_NAME}'"
           ...
           set position of item "LICENSE.md" of container window to {460, 275}
           close
           open
